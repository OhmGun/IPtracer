    ...
    def finder(u):
        try:
            try:
                ...
                print(G+"2) Provider : "+Y,data['isp'],'\n')
                print(G+"3) Kota : "+Y,data['city'],'\n')
                print(G+"4) Provinsi : "+Y,data['regionName'],'\n')
                print(G+"5) Negara : "+Y,data['country'],'\n')
                print(G+"6) Koordinat\n")
